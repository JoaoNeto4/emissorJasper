...
import classe.ImpressoraJasperReflorasul;
...
public class TelaReflorasul extends javax.swing.JDialog {

    public TelaReflorasul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tfValor.setDocument(new FormatarMoeda());
        dataAtual();
        taReferente.setText("Adiantamento em espécie.");
        tfRecebe.setText("Reflorasul");
        tfEmitente.setText("Reflorasul");
        tfCpfCnpj.setText("80.362.601/0001-83");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/reflora1.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("DejaVu Sans", 1, 28)); // NOI18N
        jLabel2.setText("RefloraSul");

        jLabel3.setText("Avenida Marechal Deodoro, 2081 -  São José");

        jLabel4.setText("Palmas - Paraná");

        jLabel7.setText("CNPJ: 80.362.601/0001-83");

        jLabel12.setText("Fone:(46) 3262-3967");
    ...
    private void jbImprimeMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbImprimeMouseReleased
        ...
        if(tfValor.getText().equals("")){
            ...
            ImpressoraJasperReflorasul imp = new ImpressoraJasperReflorasul();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaReflorasul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaReflorasul dialog = new TelaReflorasul(new javax.swing.JFrame(), true);
