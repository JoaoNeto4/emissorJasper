...
import classe.ImpressoraJasperTableros;
...
public class TelaTableros extends javax.swing.JDialog {

    public TelaTableros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tfValor.setDocument(new FormatarMoeda());
        dataAtual();
        taReferente.setText("Adiantamento em espécie.");
        tfRecebe.setText("Tableros Ind. e Com. de Paineis");
        tfEmitente.setText("Tableros Ind. e Com. de Paineis");
        tfCpfCnpj.setText("09.402.999/0001-70");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/tab.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("DejaVu Sans", 1, 28)); // NOI18N
        jLabel2.setText("Tableros");

        jLabel3.setText("Avenida Marechal Deodoro, 2081 -  São José");

        jLabel4.setText("Palmas - Paraná");

        jLabel7.setText("CNPJ: 09.402.999/0001-70");

        jLabel12.setText("Fone:(46) 3263-1515");
    ...
    private void jbImprimeMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbImprimeMouseReleased
        ...
        if(tfValor.getText().equals("")){
            ...
            ImpressoraJasperTableros imp = new ImpressoraJasperTableros();
            List listaDados = GetDados();
            imp.ImprimeRelatorio( listaDados, dialog);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTableros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaTableros dialog = new TelaTableros(new javax.swing.JFrame(), true);
